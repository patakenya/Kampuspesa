...
$payment_ref = htmlspecialchars($_GET['ref'] ?? '4178866'); // Default to 4178866 if not provided
$till_number = '4178866';
  ...
  <div class="max-w-4xl mx-auto text-center">
    ...
    <div class="bg-white rounded-2xl p-8 max-w-md mx-auto shadow-lg">
      ...
      <div class="text-left text-gray-600 mb-6">
        ...
        <p class="mb-2">2. Select <strong>Lipa na M-PESA</strong>, then <strong>Till Number</strong>.</p>
        <p class="mb-2">3. Enter Business Number: <strong><?php echo $till_number; ?></strong></p>
        <p class="mb-2">4. Enter Amount: <strong>KSh <?php echo $amount; ?></strong></p>
        <p>5. Submit the transaction code received below.</p>
      </div>
      <form method="POST" class="space-y-4">
        ...
        <input type="text" name="transaction_code" placeholder="M-PESA Transaction Code (e.g., TE81U7PN5)" class="w-full px-4 py-3 rounded-button border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary text-gray-900" required>
